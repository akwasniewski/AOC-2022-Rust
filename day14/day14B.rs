...
fn main() -> io::Result<()>{
    ...
    let mut map:[[bool;200];1000] = [[false;200];1000];
...
fn place_sand(pos: &(usize,usize), map: &mut [[bool;200];1000]) -> bool{
    if map[pos.0][pos.1]==true{
        //will only return false for the root as all other points are checked before calling function on them
        return false;
    }
